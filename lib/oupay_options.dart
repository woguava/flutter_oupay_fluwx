...
class OupayOptions{
  ...
  String _wechatUniversalLink; //IOS USER
  //招行一网通
  ...
  OupayOptions({bool isSandboxByUn:false,String unpayId:'unionpayappid',String unpayScheme:'unpayScheme',
    ...
    bool isSandboxByWechat:false, String wechatId:'wxappid',String wechatScheme:'wechatScheme',String wechatUniversalLink:'https://your.univerallink.com/link/',
